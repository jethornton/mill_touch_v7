...
"""Main entry point for mill_touch_v7.
...
Example:
    ...
    launch mill_touch_v7 by saying::

        $ mill_touch_v7 --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='mill_touch_v7',
                          vcp_name='mill_touch_v7',
